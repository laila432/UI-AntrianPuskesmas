...
class tambahjadwalpetpage extends StatefulWidget {
  const tambahjadwalpetpage({Key? key}) : super(key: key);

  @override
  State<tambahjadwalpetpage> createState() => _tambahjadwalpetpageState();
}

class _tambahjadwalpetpageState extends State<tambahjadwalpetpage> {
  @override
      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          ElevatedButton(onPressed: (){},
            ...
            child: Text('Tambah',style:TextStyle(fontSize: 20,fontWeight: FontWeight.w500)),
