...
class daftarantrianpaspage extends StatefulWidget {
  const daftarantrianpaspage({Key? key}) : super(key: key);

  @override
  State<daftarantrianpaspage> createState() => _daftarantrianpaspageState();
}

class _daftarantrianpaspageState extends State<daftarantrianpaspage> {
  @override
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          SizedBox(height: 20,),
          Text("    Nama",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 14,color:Color.fromRGBO(139, 195, 74, 1)),),
          SizedBox(height: 5,),
          ...
          SizedBox(height: 6,),
          Text("    No Hp",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 14,color:Color.fromRGBO(139, 195, 74, 1) ),),
          SizedBox(height: 5,),
          Padding(padding: EdgeInsets.only(left: 10,right: 10,bottom: 10),child: (
          ...
          SizedBox(height: 6,),
          Text("    Keluhan",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 14,color:Color.fromRGBO(139, 195, 74, 1) ),),
          SizedBox(height: 5,),
          Padding(padding: EdgeInsets.only(left: 10,right: 10,bottom: 10),child: (
          ...
          child: Text('Daftar',style:TextStyle(fontSize: 20,fontWeight: FontWeight.w500)),
