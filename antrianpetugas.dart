...
class antrianpetpage extends StatefulWidget {
  const antrianpetpage({Key? key}) : super(key: key);

  @override
  State<antrianpetpage> createState() => _antrianpetpageState();
}

class _antrianpetpageState extends State<antrianpetpage> {
  @override
              ...
              children: [
                TableRow(
                  ...
                  children: [
                    ...
                    Center(child: Text("No Hp",style: TextStyle(fontSize: 16),),),
                    Center(child: Text("Status",style: TextStyle(fontSize: 16),),),
                  ]
                ),
                //makerow("Hash","kakakka","jajjaja","ajajjaj",),
              ],
              )
            ] ,),
