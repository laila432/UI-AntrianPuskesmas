...
class editjadwalpetpage extends StatefulWidget {
  const editjadwalpetpage({Key? key}) : super(key: key);

  @override
  State<editjadwalpetpage> createState() => _editjadwalpetpageState();
}

class _editjadwalpetpageState extends State<editjadwalpetpage> {
  @override
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          SizedBox(height: 20,),
          Text("    No",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 14,color:Color.fromRGBO(139, 195, 74, 1)),),
          SizedBox(height: 5,),
          ...
          SizedBox(height: 6,),
          Text("    Waktu",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 14,color:Color.fromRGBO(139, 195, 74, 1) ),),
          SizedBox(height: 5,),
          Padding(padding: EdgeInsets.only(left: 10,right: 10,bottom: 10),child: (
          ...
          SizedBox(height: 6,),
          Text("    Hari",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 14,color:Color.fromRGBO(139, 195, 74, 1) ),),
          SizedBox(height: 5,),
          Padding(padding: EdgeInsets.only(left: 10,right: 10,bottom: 10),child: (
          ...
          Text("    Poli",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 14,color:Color.fromRGBO(139, 195, 74, 1) ),),
          SizedBox(height: 5,),
          Padding(padding: EdgeInsets.only(left: 10,right: 10,bottom: 10),child: (
          ...
          Text("    Dokter",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 14,color:Color.fromRGBO(139, 195, 74, 1) ),),
          SizedBox(height: 5,),
          Padding(padding: EdgeInsets.only(left: 10,right: 10,bottom: 10),child: (
