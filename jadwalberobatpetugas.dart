...
class jadwalberobatpetpage extends StatefulWidget {
  const jadwalberobatpetpage({Key? key}) : super(key: key);

  @override
  State<jadwalberobatpetpage> createState() => _jadwalberobatpetpageState();
}

class _jadwalberobatpetpageState extends State<jadwalberobatpetpage> {
  @override
  Widget build(BuildContext context) {
              ...
              children: [
                TableRow(
                  ...
                  children: [
                    ...
                    Center(child: Text("Aksi",style: TextStyle(fontSize: 16),),),
   ...
   TableRow makerow (id,i1,i2,i3,i4,i5){
            return TableRow(
              children: [
                Center(child: Text("$id" ,style: TextStyle(fontSize: 16),),),
                    ...
                    Center(child: Text("$i5",style: TextStyle(fontSize: 16),),),
              ]
            );
          }
